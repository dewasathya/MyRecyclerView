...
class CardViewBungaAdapter extends RecyclerView.Adapter<CardViewBungaAdapter.CardViewViewHolder>{
    private Context context;
    private ArrayList<Bunga> listBunga;
    private ArrayList<Bunga> getListBunga() {
        return listBunga;
    }
    public void setListBunga(ArrayList<Bunga> listBunga) {
        this.listBunga = listBunga;
    }
    public CardViewBungaAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull CardViewViewHolder cardViewViewHolder, int i) {
        ...
        cardViewViewHolder.btnFavorite.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Favorite "+getListBunga().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
        cardViewViewHolder.btnShare.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            @Override
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Share "+getListBunga().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
    }
